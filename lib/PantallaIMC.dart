...
class _PantallaIMCState extends State<PantallaIMCStateful> {
  ...
  Widget build(BuildContext context) {
    ...
    height: 200,
    width: 200,
    child: SvgPicture.asset("assets/images/sceptic.svg", fit: BoxFit.contain,),
    ),
    SizedBox(
    height: 8,
    ),
    ...
    setState(() {
        ...
        if(_imc >18.5 && _imc <= 25){
          _IMCModelo = IMCModelo(imc: _imc, esNormal: true, resultado: "Tu IMC esta en lo adecuado");
        }else if(_imc < 18.5){
          _IMCModelo = IMCModelo(imc: _imc, esNormal: false, resultado: "Tu IMC esta bajo del adecuado");
    }else if(_imc > 25 && _imc <= 30){
          _IMCModelo = IMCModelo(imc: _imc, esNormal: false, resultado: "Tu IMC esta arriba del adecuado");
    }else{
          _IMCModelo = IMCModelo(imc: _imc, esNormal: false, resultado: "Tu IMC esta fuera de lo adecuado");
    }});
